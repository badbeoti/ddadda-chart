...
export const divisionArr = [
  ...
  { name: '관악구', id: 3, isSelect: false },
  { name: '광진구', id: 4, isSelect: false },
  { name: '구로구', id: 5, isSelect: false },
  { name: '금천구', id: 6, isSelect: false },
  { name: '노원구', id: 7, isSelect: false },
  { name: '도봉구', id: 8, isSelect: false },
  { name: '동작구', id: 9, isSelect: false },
  { name: '동대문구', id: 10, isSelect: false },
  { name: '마포구', id: 11, isSelect: false },
  { name: '서대문구', id: 12, isSelect: false },
  { name: '서초구', id: 13, isSelect: false },
  { name: '성동구', id: 14, isSelect: false },
  { name: '성북구', id: 15, isSelect: false },
  { name: '송파구', id: 16, isSelect: false },
  { name: '양천구', id: 17, isSelect: false },
  { name: '영등포구', id: 18, isSelect: false },
  { name: '용산구', id: 19, isSelect: false },
  { name: '은평구', id: 20, isSelect: false },
  { name: '종로구', id: 21, isSelect: false },
  { name: '중구', id: 22, isSelect: false },
  { name: '중랑구', id: 23, isSelect: false },
];
